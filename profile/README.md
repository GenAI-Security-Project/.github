...
<br>
The project began as the OWASP Top 10 for LLM Applications, but has rapidly grown beyond that first project to now include over 8 working groups and 14+ projects and growing, all focused at adressing the security lifecycle for LLM, GenAI and Agentic applications. We are consolidating all of the project githubs under one umbrella to help improve collaboration, discoverability and contribution.<br>
<br>
